<h1 align="center"><img src="https://i.imgur.com/VATaXWH.png"><h2 align="center">🚧 PROJETO EM CONSTRUÇÃO 🚧</h2></h1>

<h4 align="justify"> A Imersão React é gratuita e é voltada para profissionais, estudantes e para todo mundo que quer aprender mais sobre front-end utilizando a biblioteca do React. Nesta imersão vamos mergulhar no passado e dominar o futuro com o Alurakut! O projeto é uma versão do Orkut, criado com React, styled-components e next/js. </h4>
...
## 📚 Desafios da Imersão
  - Aula 01
    ...
    - [x] Deixar o seu projeto com a sua cara - Aplicação do DarkMode;
  - Aula 02
